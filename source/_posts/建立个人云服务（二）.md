...
![长期支持版.png](https://img.imql.life/illustrations/Fti4lO_MSIy__9Kx-yCRSqgjCcN-.png)
这里选择 TAR.GZ 格式的，如下图，这种格式需要进行手动安装，下载完成后使用 SFTP 上传到无忧实例家目录下的 Atlassian 下。
![tar.gz.png](https://img.imql.life/illustrations/FnLqBGURwLEoKN9KaEQ6IFka0bvZ.png)
这里有安装手册，如下图，官方的文档写得非常好，只是需要一点英文基础。
![安装手册.png](https://img.imql.life/illustrations/Fm6Tjh4iMuS-Z9NYuDePtFXYdNKT.png)
...
![confluence.png](https://img.imql.life/illustrations/FjLGfBxu-DyUHd8yTzioojHwEMox.png)

## 下载安装 Jdk8

前往[官方下载地址](https://www.oracle.com/java/technologies/downloads/#java8)，也是下载 TAR.GZ 格式的，如下图，这里需要登录才能下载，没有账号就注册一下。
![jdk8.png](https://img.imql.life/illustrations/FkZGK_zCKC4Uog31i5oKlFMnSUbn.png)
...
![安装成功.png](https://img.imql.life/illustrations/FuDQ6OefkDaqlrn1MheZjN9t0vcI.png)
...
![回车.png](https://img.imql.life/illustrations/FjgJ1OEMckM0hf31N_q9qrThrz8b.png)
...
这里可以看到 MySQL 的具体版本：
![具体版本.png](https://img.imql.life/illustrations/FrmbHzZcuBuv6L2-MBzJZBlhlY4L.png)
...
![Platform-Independent.png](https://img.imql.life/illustrations/Fkk9ZAZwLBCN0gakBgFxGgPMA_Ey.png)
下载完成后直接解压到当前文件夹，我们只需要里面的 jar 文件，如下图，先将其上传到无忧实例家目录下的 Atlassian 下。
![jar.png](https://img.imql.life/illustrations/Fv6tBQsskajlhqSUDwKgGLnytOCw.png)
...
![language.png](https://img.imql.life/illustrations/FhjEZqRadnF48hAyEFknmoZ3N6-E.png)
选择第二个，下一步：
![第二个.png](https://img.imql.life/illustrations/FqXz0OiwwOCQ3xVuPdfYV3Q3U6oF.png)
选择“其他数据库”，设置数据库，密码就是上面自己设定的，设置好后可以点击测试连接，如下图，提示成功后下一步。
![测试连接成功.png](https://img.imql.life/illustrations/FvN5W5nShQBWeZcio56f_xiu2lql.png)
心头一震，响应失败了：
![无法处理此请求.png](https://img.imql.life/illustrations/Ftk7qjeoCxYWXbJ4qJ16w1O2ri5H.png)
马上看了一下资源使用情况，如下图，好家伙，看来这 1h2g 的配置完全不够啊。
![不堪重负.png](https://img.imql.life/illustrations/FlLDDKrKxDDKjF48IrwRouS7fGof.png)

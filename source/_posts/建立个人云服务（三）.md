...
![下载frp.png](https://img.imql.life/illustrations/FsSgdGpwFosvuYxyU6DG0anLe8-k.png)
下载完毕后上传到无忧实例家目录下。
解压缩到家目录：
...
![arm.png](https://img.imql.life/illustrations/FvVvfRrxCTPwXbNyvzME3V-9UYUU.png)
